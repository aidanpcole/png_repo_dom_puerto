...
//Check if need to take out checkies[5] on line 65 
...
const sidebarContentController = function (slide) {
  ...
  if (slide.includes("filter")) {
    ...
    checkies[1].addEventListener("change", SOURCECheck);
    checkies[2].addEventListener("change", NOTWOCheck);
    checkies[3].addEventListener("change", OZONECheck);
    checkies[4].addEventListener("change", LIGHTCheck);
    checkies[5].addEventListener("change", GREENCheck);
    checkies[6].addEventListener("change", BLUESCheck);
    checkies[7].addEventListener("change", TEMPCheck);
